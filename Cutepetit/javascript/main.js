...
const LANG_BUNDLES = {
  "en": {
    ...
    "dl_title": "✨ Download for Free",
    "dl_sub": "Fully open-source · Always free<br>Get the latest stable release from GitHub Releases",
  ...
  "zh-CN": {
    ...
    "dl_title": "✨ 立即免费下载",
    "dl_sub": "完全开源 · 永久免费<br>从 GitHub Releases 获取最新稳定版本",
  ...
  "zh-TW": {
    ...
    "dl_title": "✨ 立即免費下載",
    "dl_sub": "完全開源 · 永久免費<br>從 GitHub Releases 取得最新穩定版本",
  ...
  "ja": {
    ...
    "dl_title": "✨ 無料でダウンロード",
    "dl_sub": "完全オープンソース · 永久無料<br>GitHub Releases から最新の安定版を入手",
  ...
  "fr": {
    ...
    "dl_title": "✨ Téléchargement gratuit",
    "dl_sub": "Entièrement open-source · Toujours gratuit<br>Obtenez la dernière version stable depuis GitHub Releases",
  ...
  "ko": {
    ...
    "dl_title": "✨ 무료로 다운로드",
    "dl_sub": "완전 오픈소스 · 영원히 무료<br>GitHub Releases에서 최신 안정 버전을 받아보세요",
